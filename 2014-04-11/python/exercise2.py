...
#hole
holeVerts = [[14.8,14.4],[50.5,14.4],[14.8,33.3],[50.5,33.3]]
holeCells = [[1,2,3,4]]
hole = MKPOL([holeVerts, holeCells, pols])
hole = PROD([hole,Q(12.05)])

basementStruct = INSR(STRUCT)([coloredfirstStair,coloredsecondStair,columnBasement]) 
basementStruct = DIFFERENCE([basementStruct, hole])
...
#coverageHole
coverageHoleVerts = [[14.25,14],[51,14],[14.25,33.75],[51,33.75]]
coverageHoleCells = [[1,2,3,4]]
coverageHole = MKPOL([coverageHoleVerts, coverageHoleCells, pols])
coverageHole = PROD([coverageHole,Q(11.2)])

coverage = INSR(STRUCT)([basementTop,roof,basement,roofTop])
coverage = DIFFERENCE([coverage, coverageHole])
