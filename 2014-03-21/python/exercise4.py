...
floor0 = INSR(STRUCT)([coloredGarden,coloredfirstStair,coloredsecondStair,columnBasement,topCapitello,bottomCapitello,columns,internalWall,statueBasament,gardenNORD,gardenSUD,gardenOVEST,gardenEST,stairs,stairsWall,stairsDown,stairsBottom])
